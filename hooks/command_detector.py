...
This hook intercepts UserPromptSubmit events, detects /* commands,
...
# Maps regex patterns to config command keys
COMMAND_PATTERNS = {
    r"^/claude-spec:plan\b": "claude-spec:plan",
    r"^/claude-spec:complete\b": "claude-spec:complete",
    r"^/claude-spec:implement\b": "claude-spec:implement",
    r"^/claude-spec:status\b": "claude-spec:status",
    r"^/claude-spec:log\b": "claude-spec:log",
    r"^/claude-spec:worktree": "claude-spec:worktree",
    r"^/claude-spec:memory-remember\b": "claude-spec:memory-remember",
    r"^/claude-spec:memory-recall\b": "claude-spec:memory-recall",
    r"^/claude-spec:memory-context\b": "claude-spec:memory-context",
    r"^/claude-spec:memory\b": "claude-spec:memory",
    r"^/claude-spec:code-review\b": "claude-spec:code-review",
    r"^/claude-spec:code-fix\b": "claude-spec:code-fix",
}


def detect_command(prompt: str) -> str | None:
    """Detect /claude-spec:* command in the prompt.

    Args:
        prompt: The user prompt text

    Returns:
        The command name (e.g., "claude-spec:complete") if found, None otherwise
    """
