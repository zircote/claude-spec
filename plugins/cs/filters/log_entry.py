...
NDJSON format. Each entry captures a user interaction during a /cs:*
command session.
...
- **expanded_prompt**: Full slash command expansion. When a user invokes
  a command like ``/cs:p "project idea"``, this captures the expanded
...
class LogEntry:
    ...
    Attributes:
        ...
        command: The /cs:* command if applicable, or None.
