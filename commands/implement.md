...
**Backward compatibility:** Both string format (`argument-hint: [project-id|project-slug]`) and object format are supported per ADR-006.
</argument_schema>
...
Hint: Valid formats: SPEC-2025-12-25-001, my-project-slug, docs/spec/active/...
```
