...
description: View spec project status, list portfolio, find expired plans, or cleanup. Part of the /claude-spec suite - use /claude-spec:plan to plan, /claude-spec:complete to complete.
...
Recommended Actions:
- Use /claude-spec:complete to close finished projects
- Use /claude-spec:status --cleanup to handle outdated plans
- Extend TTL via /claude-spec:status on specific project
```
