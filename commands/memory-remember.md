...
# /memory:remember - Explicit Memory Capture
...
Examples:
- `/memory:remember decision "Chose RS256 over HS256 for JWT signing"`
- `/memory:remember learning "SQLite WAL mode improves concurrent reads"`
- `/memory:remember blocker "Cannot connect to staging database"`
</command_arguments>
...
5. Suggestion to use `/recall` to search
</output_format>
...
| Embedding failed | "Memory saved but not indexed" | "Run /memory reindex" |
</error_handling>
