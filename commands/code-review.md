...
# /review - Code Review Memory Integration
...
**Examples**:
- `/review src/auth/` - Review with memory context
- `/review --recall authentication` - Recall past auth reviews
- `/review PR#123 --capture` - Capture findings from PR review
</command_arguments>
...
Proceed with review. Use /review --capture to save findings.
```
...
| Trigger | Action |
|---------|--------|
| Finding identified | Prompt to capture with /review --capture |
