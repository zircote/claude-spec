"""
Security Reviewer Step - Pre-step for /claude-spec:complete command.
...
This step is typically configured as a pre-step for ``/claude-spec:complete``::
...
class SecurityReviewerStep(BaseStep):
    """Runs security review as pre-step for /claude-spec:complete.
